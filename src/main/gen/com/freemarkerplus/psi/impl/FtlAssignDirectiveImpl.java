...
public class FtlAssignDirectiveImpl extends ASTWrapperPsiElement implements FtlAssignDirective {

  public FtlAssignDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FtlVisitor visitor) {
    visitor.visitAssignDirective(this);
  }
